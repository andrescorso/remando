function JugadorMapamundi(posicionInicialEnPixeles, estadoJuego) {
	...
	this.rutaHojaSprites = "img/personaje48.png";
	this.personaje = 0; //elegir personaje
...
JugadorMapamundi.prototype.dirigir = function() {
	...
	if(this.velocidadY > 0) { //abajo
		this.origenXSprite = this.ancho * 8;
	}
...
JugadorMapamundi.prototype.animar = function() {
	...
	if(this.framesAnimacion >= paso2 && this.framesAnimacion < paso3) {
		origenXSpriteTemporal += this.ancho * 3;
	}
	if(this.framesAnimacion == paso3) {
		this.framesAnimacion = 0;
	}
...
JugadorMapamundi.prototype.actualizar = function(registroTemporal, mapa, personaje) {
...
JugadorMapamundi.prototype.actualizarPersonaje = function(personaje) {
	        this.origenYSprite = this.alto * personaje;
